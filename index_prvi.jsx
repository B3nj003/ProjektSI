                ...
                <div className="homepage-body">
                    <div className="homepage-category-selector">
                        <ul className="homepage-body-sneaker-selection">
                            <div id="homepage-sneaker-bold">Patike</div>
                            <div>Djeca</div>
                            <div>Kolektibiliteti</div>
                            <div>Torbe</div>
                            <div>Satovi</div>
                        </ul>
                    </div>
                    ...
                    <div className="homepage-content-body">
                        <div className="homepage-popular-brands-head">
                            ...
                            <Link to="/sneakers" className="homepage-view-all-sneaker">Vidi sve</Link>
                        </div>
                        ...
                        <div className="homepage-popular-brands-head">
                            <span> Najpopulatnije <i className="fas fa-question-circle"></i></span>
                            <Link to="/sneakers" className="homepage-view-all-sneaker">Vidi sve</Link>
                        </div>
                        ...
                        <div className="homepage-popular-brands-head">
                            <span> Predlozeno za vas <i className="fas fa-question-circle"></i></span>
                            <Link to="/sneakers" className="homepage-view-all-sneaker">Vidi sve</Link>
                        </div>
                        <ul className="homepage-sneakers-place">
                               {selectedSneaker2} 
